...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .navbar.scrolled { box-shadow: 0 4px 30px rgba(232,119,34,0.25); }
        ...
        .nav-link:hover, .nav-link.active { color: var(--orange-light) !important; }
        .dropdown-menu { background: #1A0A00; border: 1px solid rgba(232,119,34,0.2); border-radius: 4px; }
        .dropdown-item { color: rgba(255,255,255,0.75); font-size: 0.85rem; transition: all 0.2s; }
        .dropdown-item:hover { background: rgba(232,119,34,0.12); color: var(--orange-light); }
        .navbar-toggler { border: 1px solid rgba(255,255,255,0.3); }
        .navbar-toggler i { color: #fff; }

        /* ── Hero ── */
        .hero-vedic {
            background: linear-gradient(135deg, #1A0A00 0%, #2E1200 40%, #1A0A00 100%);
            position: relative;
            min-height: 92vh;
            display: flex;
            align-items: center;
        ...
        .hero-title span::after {
            ...
            animation: textReveal 2.5s ease 1.5s forwards;
        }
        ...
        .hero-btn:hover { transform: translateY(-3px); box-shadow: 0 10px 40px rgba(232,119,34,0.5); color: #fff; }
        .hero-btn::before {
            content: '';
        ...
        .hero-btn:hover::before { transform: translateX(110%) skewX(-20deg); }
        ...
        .footer .form-control:focus { background: rgba(255,255,255,0.09); border-color: var(--orange); box-shadow: none; color: #fff; }
        .btn-gold-solid {
...
<footer class="footer">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-4">
                <h2 class="cinzel text-white mb-3" style="font-family:'Cinzel',serif; font-size:1.3rem;">ASTRO <span class="text-gold">PRADEEP</span></h2>
                <p class="opacity-75 mb-4" style="font-size:0.92rem; line-height:1.85;">A legacy of 25+ years, serving over 1 million souls globally. We don't just predict the future — we help you create it.</p>
            ...
            <div class="col-lg-2">
                <h5 class="text-white mb-4" style="font-size:0.9rem; letter-spacing:0.08em; text-transform:uppercase;">Quick Links</h5>
            ...
            <div class="col-lg-3">
                <h5 class="text-white mb-4" style="font-size:0.9rem; letter-spacing:0.08em; text-transform:uppercase;">Our Services</h5>
                <ul class="footer-links">
            ...
            <div class="col-lg-3">
                <h5 class="text-white mb-4" style="font-size:0.9rem; letter-spacing:0.08em; text-transform:uppercase;">Newsletter</h5>
                <p class="small opacity-75 mb-3">Subscribe for weekly cosmic insights.</p>
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Your email">
                    <button class="btn-gold-solid">Join</button>
                </div>
            </div>
        </div>
        <div class="footer-bottom mt-5 pt-3 text-center">
            <p class="mb-0 opacity-50" style="font-size:0.82rem;">&copy; 2026 Astro Pradeep Kumar | Blessings School of Astro</p>
        </div>
    </div>
</footer>
